...
> **Warning:** You might have problems if the project's tooling relies on the path staying the same. Since CodeQuick is tool-agnostic, it's up to you to ensure your tooling can handle the path change and regenerate artifacts properly. For example, you might need to remove caches manually.
